...
<section class="footer-w3">
    <div class="container">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 footer-agile1" data-aos="zoom-in">
            <h3>联系方式</h3>
            <p>电话&nbsp;&nbsp;<span style="font-size: 22px;color: red">54615647861</span></p>
            <br>
            <p>邮件&nbsp;&nbsp;<span style="font-size: 22px;color: red">4512543@qq.com</span></p>
            <br>
            <p>官网&nbsp;&nbsp;<span style="font-size: 22px;color: red">www.CatHome.com</span></p>
            <br>
