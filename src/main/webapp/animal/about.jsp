    ...
    <div class="container">
        ...
        <div class="about-top w3ls-agile">
            <div class="col-md-6 red">
                <img class="img-responsive" src="${pageContext.request.contextPath}/images/cat1.png" alt="">
            </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-info">
                    <h4>Dog Life</h4>
                    <img src="${pageContext.request.contextPath}/images/2.png" alt=" " class="img-responsive" />
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-info">
                    <h4>Cat Life</h4>
                    <img src="${pageContext.request.contextPath}/images/1.png" alt=" " class="img-responsive" />
                    <p class="para-agileits-w3layouts">
